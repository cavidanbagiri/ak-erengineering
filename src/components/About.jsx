...
function About() {
    ...
    // Get benefits from translation file
    ...
    const startCounters = () => {
        ...
        // Get target values from translations or use defaults
        const targetProjects = parseInt(t('about.statistics.projectsTarget', { defaultValue: '500' }))
        const targetExperts = parseInt(t('about.statistics.expertsTarget', { defaultValue: '50' }))
        const targetExperience = parseInt(t('about.statistics.experienceTarget', { defaultValue: '20' }))
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-3 pt-4">
                            <div className="px-4 py-2 bg-white/5 rounded-full border border-white/10">
                                <span className="text-yellow-400 font-semibold">{t('about.certifications.iso')}</span>
                            </div>
                            <div className="px-4 py-2 bg-white/5 rounded-full border border-white/10">
                                <span className="text-yellow-400 font-semibold">{t('about.certifications.ce')}</span>
                            </div>
                            <div className="px-4 py-2 bg-white/5 rounded-full border border-white/10">
                                <span className="text-yellow-400 font-semibold">{t('about.certifications.rohs')}</span>
                            </div>
                        </div>
                    </div>
                                ...
                                >
                                    <div className="flex-shrink-0 w-12 h-12 bg-yellow-400/10 rounded-lg flex items-center justify-center group-hover:bg-yellow-400/20 transition-all duration-300">
                                        <span className="text-2xl">
                                            {benefit.icon || getBenefitIcon(index)}
                                        </span>
                                    </div>
                ...
                >
                    <div className="text-center p-6 bg-gradient-to-br from-white/5 to-transparent rounded-2xl hover:scale-105 transition-all duration-300">
                        ...
                        <div className="text-gray-300 font-medium">{t('about.statistics.projects')}</div>
                        <div className="text-gray-500 text-sm mt-2">{t('about.statistics.projectsLocation')}</div>
                    </div>
                    ...
                    <div className="text-center p-6 bg-gradient-to-br from-white/5 to-transparent rounded-2xl hover:scale-105 transition-all duration-300">
                        ...
                        <div className="text-gray-300 font-medium">{t('about.statistics.experience')}</div>
                        <div className="text-gray-500 text-sm mt-2">{t('about.statistics.experienceSub')}</div>
                    </div>
                    ...
                    <div className="text-center p-6 bg-gradient-to-br from-white/5 to-transparent rounded-2xl hover:scale-105 transition-all duration-300">
                        ...
                        <div className="text-gray-300 font-medium">{t('about.statistics.experts')}</div>
                        <div className="text-gray-500 text-sm mt-2">{t('about.statistics.expertsSub')}</div>
                    </div>
                </div>
...
// Helper function for benefit icons (fallback)
