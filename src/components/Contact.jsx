                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                        <div className="bg-white/5 rounded-xl p-6 text-center border border-white/10 hover:border-yellow-400/50 transition-all duration-300 hover:-translate-y-1">
                            ...
                            <p className="text-gray-400 text-xs mt-1">{t('contact.contactInfo.phone.hours')}</p>
                        </div>
                        ...
                        <div className="bg-white/5 rounded-xl p-6 text-center border border-white/10 hover:border-yellow-400/50 transition-all duration-300 hover:-translate-y-1">
                            ...
                            <p className="text-gray-400 text-xs mt-1">{t('contact.contactInfo.email.response')}</p>
                        </div>
                        ...
                        <div className="bg-white/5 rounded-xl p-6 text-center border border-white/10 hover:border-yellow-400/50 transition-all duration-300 hover:-translate-y-1">
                            ...
                            <h3 className="text-white font-semibold mb-2">{t('contact.contactInfo.address.title')}</h3>
                            <p className="text-gray-300 text-sm">{t('footer.contact.address')}</p>
                            <p className="text-gray-400 text-xs mt-1">{t('contact.contactInfo.address.visit')}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/5 rounded-2xl p-6 md:p-8 lg:p-10 border border-white/10">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-yellow-400 to-yellow-600 px-8 py-4 rounded-lg text-gray-900 font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-yellow-400/25 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 group"
                            >
                                {isSubmitting ? (
                                    <>
