...
function ServiceDetail() {
    ...
    useEffect(() => {
        // Get service details from translation file
        const getServiceDetails = () => {
            try {
                // Dynamic import or direct access to translation data
                const details = t(`serviceDetails.${serviceSlug}`, { returnObjects: true })

                if (details && Object.keys(details).length > 0) {
                    setServiceData(details)
                } else {
                    // Service not found - redirect to 404 or services page
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
            ...
            <section className="relative py-20 md:py-28 overflow-hidden">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        {/* GERİ DÖNÜŞ BUTONU - YENİ */}
                        <div className="mb-6">
                            <Link
                                to="/services"
                                className="inline-flex items-center gap-2 text-yellow-400 hover:text-yellow-300 transition-colors duration-300 group"
                            >
            ...
            <section className="py-16 md:py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-yellow-600/10 to-orange-600/10 rounded-2xl p-8 md:p-12 backdrop-blur-sm border border-yellow-400/20">
                        ...
                        <Link
                            to="/contact"
                            className="inline-flex items-center gap-2 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-8 py-3 rounded-lg transition-all duration-300 transform hover:scale-105"
                        >
